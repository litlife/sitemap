...
class Sitemap
{
	...
	private int $maxSize = 49500000;
	private int $maxUrlCount = 49500;
	private array $urls = [];
    ...
    public function addUrl($location, $lastmod = null, $changefreq = 'weekly', $priority = '0.5'): bool
	{
		...
		if (!empty($priority)) {
			...
			if (!preg_match('/([0,1])\.([0-9])/iu', $priority))
	...
	public function setSize(int $number)
	{
		$this->size = $number;
	}
	...
	public function setUrlCount(int $number)
	{
	...
	public function setMaxUrlCount(int $count)
	{
	...
	public function getWhereLocation(string $location) :array|bool
	{
