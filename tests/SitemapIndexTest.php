...
class SitemapIndexTest extends TestCase
{
    ...
    public function testAddSitemap()
	{
		...
		$index->addSitemap('https://www.example.com/sitemap1.xml.gz', '2004-10-01T18:23:17+00:00');
		$index->addSitemap('https://www.example.com/sitemap2.xml.gz', '2005-10-01T18:23:17+00:00');
		...
		$this->assertEquals('https://www.example.com/sitemap1.xml.gz',
		...
		$this->assertEquals('https://www.example.com/sitemap2.xml.gz',
			$xpath->query("*[local-name()='loc']", $sitemap)->item(0)->nodeValue);
    ...
    public function testOpen()
	{
		...
		$this->assertEquals('https://www.example.com/sitemap1.xml.gz', $lastSitemap['location']);
	...
	public function getLastSitemap()
	{
		...
		$this->assertEquals('https://www.example.com/sitemap2.xml.gz', $lastSitemap['location']);
	}
}
